...
class MainActivity : AppCompatActivity() {
    ...
    private val headers : List<String> = listOf("Bid","Ask","Pin","Puk")
    private val dataList : List<Data> = listOf(
        Data(
            date = "12 Aug 21",
            callData = listOf(25.30,0.18,18.99,24.77, 25.30,0.18,18.99,24.77,25.30,0.18,18.99,24.77),
            putData = listOf(11.11,22.22,33.33,44.44, 1.11,22.22,33.33,44.44, 1.11,22.22,33.33,44.44),
